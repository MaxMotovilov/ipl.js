...
exports.run = function( args, body ) {
	...
	return this.dontRun || this.isScript ? beautify( result ) : result;
}
...
exports.substitution = function( text, raw, long ) {
	if( this.stack[0].substitution )
		append( this.body, this.stack[0].substitution( text, raw, long ) );
	else
