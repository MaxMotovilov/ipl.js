...
function beautifier( verb ) {
	...
	function adapt( minify ) {
		return function( text ) {
			return minify( text, { fromString: true, output: { inline_script: true } } ).code;
		}
	}
}
...
exports.generate = function( input, env, is_script, args ) {
	...
	_this.env.$ipl = { beautify: beautifier() };
...
exports.run = function( args, body ) {
	...
	return this.dontRun  ? this.beautifier( "beautify" )( result )
...
exports.tag = function( name, args, line ) {
	...
	if( name == 'global' ) {
		...
		append( body, exports.builders.build.global( args[0] ) );
